...
int main()
{
    ...
    for(auto& word : peaceFilteredChapters[peaceFilteredChapters.size() - 1]){
        std::cout << word << std::endl;
    }

    std::cout << "WAR" << std::endl;
    for(auto& word : warFilteredChapters[warFilteredChapters.size() - 1]){
        std::cout << word << std::endl;
    }

    std::cout << "CHAPTERS WAR: " << warFilteredChapters.size() << std::endl;
